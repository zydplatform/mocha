...
/**
 * Given yargs-like "Arguments" opts, split into node and mocha args
 * @param {object} opts - Arguments
 * @returns {{nodeArgs: string[], mochaArgs: string[]}} Unparsed
 */
exports.unparse = function unparse(opts) {
  debug('unparsing: %O', opts);
  const mochaArgs = {_: []};
  const nodeArgs = {};
  ...
  debug('initial unparsed mocha args: %O', mochaArgs);
  debug('initial unparsed node args: %O', nodeArgs);
